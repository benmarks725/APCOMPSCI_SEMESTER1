...
public class Picture extends SimplePicture 
{
   ...
   public void copy(Picture fromPic, int fromStartRow, int fromStartCol, int fromEndRow, int fromEndCol, int toStartRow, int toStartCol)
  {
    ...
    for (int fromRow = fromStartRow, toRow = toStartRow; fromRow <= fromEndRow && toRow < toPixels.length; fromRow++, toRow++)
    {
      for (int fromCol = fromStartCol, toCol = toStartCol; 
           fromCol <= fromEndCol && toCol < toPixels[0].length; fromCol++, toCol++)
      {
        fromPixel = fromPixels[fromRow][fromCol];
        toPixel = toPixels[toRow][toCol];
        toPixel.setColor(fromPixel.getColor());
  ...
  public void KawhiUnderWater()
  {
	  Picture kawhileonhard = new Picture("kawhileonhard.jpeg");
	  this.copy(kawhileonhard, 135, 196);
	  this.copy(kawhileonhard, 0, 0);
	  this.copy(kawhileonhard, 200, 400);
	  this.mirrorVertical();
	  this.mirrorHorizontal();
	  this.mirrorHorizontalBotToTop();
	  this.write("kawhileonhardunderwater.jpg");
  }
